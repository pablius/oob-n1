...
abstract class PhpExt_Component extends PhpExt_Observable
{
	...
	*/
	...
	public function setEnableKeyEvents($value){
		$this->setExtConfigProperty("enableKeyEvents", $value);
		return $this;
	}	
        
	public function setDescripcion($value){
		$this->setExtConfigProperty("descripcion", $value);
		return $this;
	}	
    
	public function setRequerido($value){
		$this->setExtConfigProperty("requerido", $value);
		return $this;
	}		
	
	public function setValidez($value){
		$this->setExtConfigProperty("validez", $value);
		return $this;
	}	
	
	public function setOtherParam($value){
		$this->setExtConfigProperty("otherparam", $value);
		return $this;
	}
