...
class PhpExt_Grid_GridEditorCollection extends PhpExt_AbstractCollection 
{
	...
	/**
	 * Adds a PhpExt_GridEditor to the Collection
	 *
	 * @param PhpExt_GridEditor $object
	 * @param string $name
	 * @return int the index of the new element
	 */					
	public function add(PhpExt_GridEditor $object, $name = null) {
    ...
    public function getJavascript() {
		...
		foreach($this->Collection as $propertyName=>&$editor) {
		    $resolvedObjs[] = "'$propertyName': ".$editor->getJavascript(false);						
		}		
