...
class PhpExt_Grid_GridPanel extends PhpExt_Panel 
{
	...
	public function setenableColLock($value) {
    	$this->setExtConfigProperty("enableColLock", $value);
    	return $this;
    }	
    
    public function getenableColLock() {
    	return $this->getExtConfigProperty("enableColLock");
    }
