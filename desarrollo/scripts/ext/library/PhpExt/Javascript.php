...
class PhpExt_Javascript {
	...
	static public function callfunction($functionName,$functionParams = array()) {
		$functionName = ($functionName === null)?"":" ".$functionName;	
		$function = "$functionName(".implode(",",$functionParams).");";
		
		return PhpExt_Javascript::inlineStm($function);
	}
	
	static public function functionNoDef($functionName, $functionBody, $functionParams = array()) {
		$functionName = ($functionName === null)?"":" ".$functionName;
