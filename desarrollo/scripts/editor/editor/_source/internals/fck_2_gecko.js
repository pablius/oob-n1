...
//**
// FCK.InsertHtml: Inserts HTML at the current servicior location. Deletes the
...
FCK.InsertHtml = function( html )
{
	...
	// Set the servicior after the inserted fragment.
...
FCK.InsertElement = function( element )
{
	...
	//element = document.createElement("custom");
	//element.innerHTML = "{imagen id=1}"
...
FCK.PasteImageText = function(text)
{
	// Delete the actual selection.
	var oSel = FCKSelection.Delete() ;
	...
	// Set the servicior after the inserted text.
	FCKSelection.SelectNode( oTextNode ) ;
	FCKSelection.Collapse( false ) ;
