...
/*
Verifica si se agregó alguna imagen en la ventana instancia_modificar
- Valores de retorno:
	 1  => se han agregado imagenes
	 0  => no se han agregado imagenes
	-1 => no se puede agregar imagenes porq la estructura no lo permite
*/
FCK.HasImage = function()
{
	try
	{//por si la tabla no existe...
		var table = window.parent.document.getElementById("Tableimagenes_image");
