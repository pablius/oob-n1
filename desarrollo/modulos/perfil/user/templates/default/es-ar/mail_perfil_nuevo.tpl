...
<div id="cont_lista">
	...
	<div class="hzl"></div>
	 Gracias por registrarse!<br /> En breve su usuario ser&aacute; confirmado y podr&aacute; comenzar a operar. 
	<div class="hzl"></div>
	...
	<div class="box_nocontenedores">
			...
			<table width="100%" border="0" cellspacing="5">
			  ...
			  <tr>
				<td colspan="2"><b>e-Mail</b><br>
				{$email}
				<td><b>Tel&eacute;fono</b><br>
				 {$telefono}
				</td>
			  </tr>
