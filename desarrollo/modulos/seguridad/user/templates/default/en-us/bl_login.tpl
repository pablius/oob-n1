...
{if $logued} <span class="texto6">Wellcome</span> <span class="texto6">{$uname}</span><font class="style1"> (<a class="texto5" href="{$webdir}/seguridad/logout">Exit</a> | <a class="texto5" href="{$webdir}/seguridad/update">Password Update </a>)</font> {else}
<form name="login" method="post" action="{$webdir}/seguridad/login">
  ...
  <tr>
    <td valign="bottom">
      <div align="right"><span class="texto6">User:&nbsp;</span><font class="style1">
        <input name="uname" class="portada_box" type="text" id="uname" size="15">
  &nbsp;&nbsp;
           </font><span class="texto6">Password:</span><font class="style1"> &nbsp;
           <input name="pass" class="portada_box"  type="password" id="pass" size="15" maxlength="8">
  &nbsp;
           <input name="login" type="submit" id="login" class="portada_button"  value="Login">
  &nbsp;
  &nbsp;    </font>        </div>  </td>
