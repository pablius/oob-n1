...
/**
   ...
   This class allows a PHP script to determine the mime type
   ...
   Example:  $mimetype = OOB_mimetype::getType('acrobat.pdf');
...
class OOB_mimetype {
   ...
   public function getType($filename) {
      ...
      // find mime type
      return $objeto->FindType($filename);
   }
   
   
     public function getExtention($mime) {
      ...
      $objeto = new OOB_mimetype ();
      $mimetypes = $objeto->BuildMimeArray();
	  $ext = array_flip ($mimetypes);
   ...
   private function BuildMimeArray() {
      return array(
