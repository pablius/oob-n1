...
*/
	...
	/*	Constructor */
	//adicion 22-12-05
	function email_message_class()
	{
		$this->smtp = new smtp_class();
		$this->smtp->localhost="localhost";
		$this->smtp->host_name="localhost";
		$this->smtp->host_port="25";	
	}
	//
...
//		var_dump($body);
//		var_dump($headers);
//		var_dump($return_path);
//		exit;

		$keys = array_keys($this->headers);
		foreach($keys as $k)
		{	$headers .= "\r\n" . $k . ": ". $this->headers[$k] ;	}//end foreach 	
...
//			//modificacion 22-12-05	
		//	var_dump($headers);
		
			$this->smtp->SendMessage("",$to, $headers,$body);
			if ( !strlen( $this->smtp->error ) )
			{	$sucess = true;	}			
//var_dump($this->smtp->error);
//		}
//		else
//		{
			//$success=@mail($to,$subject,$body,$headers);
			//modificacion 22-12-05
//			$this->smtp->SendMessage("",array("victor.stornati@nutus.com.ar"),$head,$body);
		//	var_dump($this->smtp->error);	
//		}		
		return  $sucess; // ? "" : $this->OutputPHPError("it was not possible to send e-mail message", $php_errormsg));
	}
