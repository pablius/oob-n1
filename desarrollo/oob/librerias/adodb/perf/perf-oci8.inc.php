...
AND    b.name = 'sorts (memory)'",
	...
	'Parameters',	
		'servicior sharing' => array('SERVICIOR',
			"select value from v\$parameter where name = 'servicior_sharing'",
			'Servicior reuse strategy. Recommended is FORCE (8i+) or SIMILAR (9i+). See <a href=http://www.praetoriate.com/oracle_tips_servicior_sharing.htm>servicior_sharing</a>.'),
		/*
		'servicior reuse' => array('SERVICIOR',
