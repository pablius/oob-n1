...
//			if ($argHostname) putenv("ORACLE_HOME=$argHostname");
		...
		function _query($sql,$inputarr=false)
		{
            ...
            // <G. Giunta 2004/03/03> before we close the servicior, we have to store the error message
            // that we can obtain ONLY from the servicior (and not from the connection)
