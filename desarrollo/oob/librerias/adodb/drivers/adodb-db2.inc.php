...
Serviciortype when calling odbc_pconnect(....).

And the exciting thing: When we set the servicior type
to SQL_CUR_USE_ODBC Servicior Type, then
...
SQL_ATTR_ODBC_SERVICIORS (DB2 CLI v5) 
...
A 32-bit option specifying how the Driver Manager uses the ODBC servicior
library. 
