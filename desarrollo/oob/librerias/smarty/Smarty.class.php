 ...
 */
    ...
    {
    	// OOB Compatibility
    	throw new OOB_exception("Smarty: $error_msg", "000", "Ha ocurrido un error de ejecución", true);
   //     trigger_error("Smarty error: $error_msg", $error_type);
    ...
    function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false)
    {
        ...
        if ($display && !$this->caching && count($this->_plugins['outputfilter']) == 0) 
		{
            ...
            {
				//@todo => a veces no se muestra el popup de imagenes_newpopup.tpl (se muestra en blanco)
				//var_dump($_smarty_compile_path);echo "<br><br>";
