...
$ari->t->assign("amigos", perfil_amigo::get_mis_amigos($_GET['pos']));
$ari->t->assign("amigos_count", perfil_amigo::get_mis_amigos_count());
$ari->t->assign("limit", $limit);


$ari->t->display($ari->module->usertpldir(). DIRECTORY_SEPARATOR."perfil_amigos.tpl");
